namespace Project4.Migrations
{
    ...
    public partial class update0331_2 : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.PhamNhans", "AnhNhanDien", c => c.String(nullable: false));
            ...
            AlterColumn("dbo.QuanNgucs", "AnhNhanDien", c => c.String(nullable: false));
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.QuanNgucs", "AnhNhanDien", c => c.String());
            ...
            AlterColumn("dbo.PhamNhans", "AnhNhanDien", c => c.String());
